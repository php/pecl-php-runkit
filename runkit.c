...
PHP_MINIT_FUNCTION(runkit)
{
	...
	REGISTER_LONG_CONSTANT("RUNKIT_ACC_ALLOW_STATIC",		ZEND_ACC_ALLOW_STATIC,					CONST_CS | CONST_PERSISTENT);
#else /* ZEND_ENGINE_1 */
	REGISTER_LONG_CONSTANT("RUNKIT_ACC_PUBLIC",			0,							CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_ACC_PROTECTED",			0,							CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_ACC_PRIVATE",			0,							CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_ACC_STATIC",			0,							CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTNAT("RUNKIT_ACC_ALLOW_STATIC",		0,							CONST_CS | CONST_PERSISTENT);
#endif
